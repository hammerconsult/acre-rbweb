...
public class GrupoUsuarioIT {
	...
	@Test
	public void testEGrupoUsuario() throws Exception {
		...
		driver.findElement(By.id("grupoUsuario")).click();
		driver.switchTo().frame("corpo");
		driver.findElement(By.id("listaGrupoUsuario:formTabelaGenerica:botaoNovo")).click();
		driver.findElement(By.id("Formulario:nome")).click();
		driver.findElement(By.id("Formulario:nome")).clear();
		driver.findElement(By.id("Formulario:nome")).sendKeys("Grupo de Usuário Teste");
		driver.findElement(By.id("Formulario:sigla")).clear();
		driver.findElement(By.id("Formulario:sigla")).sendKeys("GUT");
		driver.findElement(By.id("Formulario:rodapeEditar:salvar")).click();

                assertEquals("Salvo com Sucesso", driver.findElement(By.id("listaGrupoUsuario:msgs")).getText());
	}
