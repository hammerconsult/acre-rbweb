...
public class PaisIT {
	...
	@Test
	public void testEPais() throws Exception {
		...
		driver.findElement(By.id("listaPais:formTabelaGenerica:botaoNovo")).click();
		driver.findElement(By.id("Formulario:nome")).click();
		driver.findElement(By.id("Formulario:nome")).clear();
		driver.findElement(By.id("Formulario:nome")).sendKeys("Pais de Teste");
		driver.findElement(By.id("Formulario:ddi")).clear();
		driver.findElement(By.id("Formulario:ddi")).sendKeys("89");
