...
public class NacionalidadeIT {
	...
	@Test
	public void testENacionalidade() throws Exception {
		...
		driver.findElement(By.id("listaNacionalidade:formTabelaGenerica:botaoNovo")).click();
		driver.findElement(By.id("Formulario:descricao")).click();
		driver.findElement(By.id("Formulario:descricao")).clear();
		driver.findElement(By.id("Formulario:descricao")).sendKeys("Testenes");
		driver.findElement(By.id("Formulario:rodapeEditar:salvar")).click();

                assertEquals("Salvo com Sucesso", driver.findElement(By.id("listaNacionalidade:msgs")).getText());
	}
