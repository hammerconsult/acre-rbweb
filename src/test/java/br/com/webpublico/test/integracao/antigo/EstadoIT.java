...
public class EstadoIT {
	...
	@Test
	public void testEEstado() throws Exception {
		...
		driver.findElement(By.id("Formulario:nome")).sendKeys("Estado Teste André");
		driver.findElement(By.id("Formulario:uf")).clear();
		driver.findElement(By.id("Formulario:uf")).sendKeys("ET");
		((JavascriptExecutor) driver).executeScript("document.forms['Formulario'].elements['Formulario:pais_hinput'].value = '125'");
