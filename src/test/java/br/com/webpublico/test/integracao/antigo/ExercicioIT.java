...
public class ExercicioIT {
	...
	@Test
	public void testEExercicio() throws Exception {
		driver.get("http://localhost:8080/webpublico/");
		driver.findElement(By.cssSelector("input[type=submit]")).click();
		driver.findElement(By.linkText("Cadastros Gerais")).click();
		driver.findElement(By.linkText("Exercício")).click();
		driver.switchTo().frame("corpo");
		driver.findElement(By.id("listaExercicio:formTabelaGenerica:botaoNovo")).click();
		driver.findElement(By.id("Formulario:ano")).click();
