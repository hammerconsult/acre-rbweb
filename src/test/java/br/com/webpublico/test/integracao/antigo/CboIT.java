...
public class CboIT {
	...
	@Test
	public void testECbo() throws Exception {
		...
		driver.findElement(By.id("cbo")).click();
		driver.switchTo().frame("corpo");
		driver.findElement(By.id("listaCbo:formTabelaGenerica:botaoNovo")).click();
		driver.findElement(By.id("Formulario:descricao")).click();
		driver.findElement(By.id("Formulario:descricao")).clear();
		driver.findElement(By.id("Formulario:descricao")).sendKeys("CBO TESTE");
		driver.findElement(By.id("Formulario:codigo")).clear();
		driver.findElement(By.id("Formulario:codigo")).sendKeys("0123");
		driver.findElement(By.id("Formulario:rodapeEditar:salvar")).click();

                assertEquals("Salvo com Sucesso", driver.findElement(By.id("listaCbo:msgs")).getText());
	}
