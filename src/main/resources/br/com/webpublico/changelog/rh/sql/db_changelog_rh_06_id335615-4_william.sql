update contratofp set segmentoatuacao = null;
    ...
    where to_date('01/2021', 'MM/yyyy') between lotacao.INICIOVIGENCIA and coalesce (lotacao.FINALVIGENCIA, to_date('01/2021', 'MM/yyyy'))
      and lotacao.UNIDADEORGANIZACIONAL_ID in
          (58757559, 58757558, 58757252, 638875131, 58758539, 58758541,
           ...
           58756975,
           58758560, 638875240, 584889240, 58758538
              )
);
    ...
    where to_date('01/2021', 'MM/yyyy') between lotacao.INICIOVIGENCIA and coalesce (lotacao.FINALVIGENCIA, to_date('01/2021', 'MM/yyyy'))
      and lotacao.UNIDADEORGANIZACIONAL_ID in
          (10651504139, 10651503971,
           ...
           779892845, 779892202, 58758533, 58758534, 638875158, 58758558, 58758528, 58758531, 58757945, 58757897, 58757872
              )
);
