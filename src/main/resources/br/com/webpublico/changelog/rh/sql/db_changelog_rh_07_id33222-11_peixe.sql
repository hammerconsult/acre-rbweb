...
VALUES (hibernate_sequence.nextval, '1104', null, '13º Salário Maternidade - RPSS',
        'return 0;',
        'return 0;',
        'return calculador.quantidadeMesesTrabalhadosAno();',
        'return false;',
        'VANTAGEM', 1,
        null, 'FOLHA', null, 'return calculador.salarioBase();', '13º Salário Mater. RPPS', 1, 0, 'REFERENCIA', 0,
