CREATE OR REPLACE FORCE VIEW VWCONSULTADEDEBITOS
  ...
  SELECT DISTINCT CADASTRO.ID AS CADASTRO_ID,
    ...
    ROUND(PACOTE_CONSULTA_DE_DEBITOS.GETVALORCORRECAO( PVD.ID, extract(YEAR FROM pvd.vencimento),1), 2) AS VALORCORRECAO,
    ...
    ROUND(PACOTE_CONSULTA_DE_DEBITOS.GETVALORIMPOSTO(PVD.ID,1), 2)                                      AS VALORIMPOSTO,
    ROUND(PACOTE_CONSULTA_DE_DEBITOS.GETVALORTAXA(PVD.ID,1), 2)                                         AS VALORTAXA,
