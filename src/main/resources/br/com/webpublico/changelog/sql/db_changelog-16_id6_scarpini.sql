...
BEGIN
  ...
  IF to_date(PARAM_DATA_VENCIMENTO, 'dd/MM/yyyy') >= to_date(PARAM_DATA_OPERACAO, 'dd/MM/yyyy') THEN
    RETURN 0;
  END IF;
  ...
  DIFERENCA_MESES   := MONTHS_BETWEEN (PARAM_DATA_OPERACAO , PARAM_DATA_VENCIMENTO);
