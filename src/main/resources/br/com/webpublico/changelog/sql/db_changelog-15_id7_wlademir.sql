  ...
  CREATE OR REPLACE FORCE VIEW VWHIERARQUIAADMINISTRATIVA ("ID", "SUPERIOR_ID", "SUBORDINADA_ID", "ENTIDADE_ID", "CODIGO", "DESCRICAO", "EXERCICIO_ID", "TIPOUNIDADE", "ESFERADOPODER", "INICIOVIGENCIA", "FIMVIGENCIA", "ANO") AS 
