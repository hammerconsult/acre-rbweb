CREATE OR REPLACE FORCE VIEW VWHIERARQUIAORCAMENTARIA (ID, SUPERIOR_ID, SUBORDINADA_ID, ENTIDADE_ID, CODIGO, DESCRICAO, EXERCICIO_ID, TIPOUNIDADE, TIPOADMINISTRACAO, ESFERADOPODER, CLASSIFICACAOUO, INICIOVIGENCIA, FIMVIGENCIA, ANO) AS
  SELECT raiz.id,
    raiz.superior_id,
    raiz.subordinada_id,
    ent.id AS entidade,
