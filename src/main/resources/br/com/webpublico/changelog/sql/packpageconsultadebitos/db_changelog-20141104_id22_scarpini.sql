...
EXTRACT(YEAR FROM PARAM_DATA_VENCIMENTO),0);
  END IF;
...
FROM PARAM_PARCELA_VENCIMENTO),1), 2);
...
AS
  VALOR NUMBER;
BEGIN
  IF PARAM_SITUACAO_PARCELA != 'PAGO' AND PARAM_SITUACAO_PARCELA != 'BAIXADO' AND PARAM_SITUACAO_PARCELA != 'PAGO_REFIS' AND PARAM_SITUACAO_PARCELA != 'PAGO_PARCELAMENTO' THEN
    RETURN 0;
  END IF;
