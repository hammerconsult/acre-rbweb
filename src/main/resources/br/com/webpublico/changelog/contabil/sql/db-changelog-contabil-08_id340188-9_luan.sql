...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE PAGAMENTO</strong></td>
...
<tbody>
<tr>
<td style="text-align: center;"><strong>17. Valor Liquidado R$</strong></td>
<td style="text-align: center;"><strong>18. Valor da Nota R$</strong></td>
<td style="text-align: center;"><strong>19. Saldo a Pagar R$</strong></td>
</tr>
<tr>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 147 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_PAGAMENTO');
END;
