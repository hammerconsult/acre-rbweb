...
values (HIBERNATE_SEQUENCE.nextval, 608930532, 'LINK', '{"consulta":"select * from dual $WHERE","count":"select count(1) from dual","totalRegistros":1,"fields":[],"pesquisaveis":[],"tabs":[]}',
        'Sistema de Controle Interno Municipal', 'http://portalcgm.riobranco.ac.gov.br/portal/controle-interno-e-contabilidade/organizacao-sistema-controle-interno/', 'TABELA', '<div></div>', 0, 1, 736067050)
