...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 157 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_RESTO_LIQUIDACAO');
END;
