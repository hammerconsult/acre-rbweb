...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE ESTORNO DE DESPESA EXTRAOR&Ccedil;AMENT&Aacute;RIA<br /></strong></td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 152 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_PAGAMENTO_EXTRA_ESTORNO');
END;
