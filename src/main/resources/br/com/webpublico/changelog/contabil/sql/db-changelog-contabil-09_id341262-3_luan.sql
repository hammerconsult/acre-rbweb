...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE PAGAMENTO DE RESTO A PAGAR</strong></td>
...
<div style="text-align: left;">&nbsp;</div>
<div style="border-top: 1px solid; text-align: left;"><span><strong>14. Banco/Ag&ecirc;ncia/Conta</strong></span></div>
...
<tbody>
<tr>
<td style="text-align: center;"><strong>17. Saldo Anterior R$</strong></td>
<td style="text-align: center;"><strong>18. Valor da Nota R$</strong></td>
<td style="text-align: center;"><strong>19. Saldo Atual R$</strong></td>
</tr>
<tr>
...
<tbody>
<tr>
<td><strong>22. Conta Financeira</strong></td>
</tr>
<tr>
<td>$CONTA_FINANCEIRA</td>
</tr>
</tbody>
</table>
<table style="border-collapse: collapse; width: 884px; height: 40px;" border="1" cellspacing="0">
<tbody>
<tr>
<td><strong>23. Reten&ccedil;&otilde;es</strong></td>
</tr>
<tr>
<td style="text-align: right;">$RETENCOES</td>
</tr>
</tbody>
</table>
<table style="border-collapse: collapse; width: 884px; height: 40px;" border="1" cellspacing="0">
<tbody>
<tr>
<td><strong>24. Guias</strong></td>
</tr>
<tr>
<td style="text-align: right;">$FATURAS $CONVENIOS $GPS $DARFS $DARFS_SIMPLES</td>
</tr>
</tbody>
</table>
<table style="border-collapse: collapse; width: 884px; height: 40px;" border="1" cellspacing="0">
<tbody>
<tr>
<td style="border-right: 0px solid; text-align: left; width: 50%;"><strong>25. Assinaturas</strong></td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 155 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_RESTO_PAGAMENTO');
END;
