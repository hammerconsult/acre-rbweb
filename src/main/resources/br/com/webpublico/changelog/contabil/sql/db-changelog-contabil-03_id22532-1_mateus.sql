 CREATE OR REPLACE VIEW VWHIERARQUIADESPESAORC (ID, ORGAO, UNIDADE, SUBACAO, CONTA, EXERCICIO, UNIDADE_ID, TIPOCONTADESPESA, INICIOVIGENCIA, FIMVIGENCIA, CODIGOREDUZIDO, CONTA_ID) AS
  SELECT D.ID AS id,
    hoUo.CODIGO
    ||' - '
    ||hoUo.DESCRICAO AS ORGAO,
    HO.CODIGO
    ||' - '
