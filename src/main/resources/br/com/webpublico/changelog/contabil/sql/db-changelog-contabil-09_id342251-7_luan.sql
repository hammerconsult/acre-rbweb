...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 161 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_OBRIGACAO_A_PAGAR_ESTORNO');
END;
