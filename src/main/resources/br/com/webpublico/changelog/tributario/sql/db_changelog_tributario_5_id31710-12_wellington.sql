CREATE OR REPLACE VIEW VWCONSULTADEDEBITOS
(CADASTRO_ID,PESSOA_ID,DIVIDA_ID,DIVIDA,DIVIDA_ISDIVIDAATIVA,CALCULO_ID,VALORDIVIDA_ID,PARCELA_ID,SITUACAOPARCELA_ID,
SITUACAOPARCELA,EXERCICIO_ID,EXERCICIO,OPCAOPAGAMENTO_ID,VALORORIGINAL,VALORCORRECAO,VALORJUROS,VALORMULTA,VALORHONORARIOS,
VALORIMPOSTO,VALORTAXA,VALORDESCONTO,PARCELA,PROMOCIONAL,VALORPAGO,DATAPAGAMENTO,EMISSAO,PROCESSOCALCULO,
QUANTIDADEIMPRESSOESDAM,VENCIMENTO,CONFIGURACAOACRESCIMO_ID,TIPOCALCULO,DIVIDAATIVA,DIVIDAATIVAAJUIZADA,SD,NUMEROPARCELA,
ORDEMAPRESENTACAO,OBSERVACAO,PERMISSAOEMISSAODAM,ULTIMAATUALIZACAOVALORES,ISENTA_ACRESCIMOS)
AS
