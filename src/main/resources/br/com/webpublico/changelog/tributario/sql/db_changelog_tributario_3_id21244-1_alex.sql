  ...
  CREATE OR REPLACE FORCE VIEW VWCONSULTADIVIDAATIVA ("ID_CADASTRO", "CADASTRO", "EXERCICIO", "ID_PESSOA", "ID_CALCULO", "SD", "ID_VALORDIVIDA", "EMISSAO", "ID_PARCELA", "ID_OPCAOPAGAMENTO", "COTAUNICA", "VENCIMENTO", "SITUACAOPARCELA", "REFERENCIA", "PARCELA", "VALORORIGINAL", "DIVIDA", "ID_DIVIDA", "DIVIDAATIVA", "DIVIDAATIVAAJUIZADA", "PAGAMENTO", "ID_CONFIGURACAOACRESCIMO", "TIPO_CADASTRO", "CPFCNPJ", "NOMERAZAOSOCIAL", "NUMERO_INSCRICAO", "ANO_INSCRICAO", "NUMERO_CDA", "NUMERO_AJUIZAMENTO", "EXERCICIO_CDA", "SITUACAO_PROCESSO_JUDICIAL") AS
  select distinct
           ...
           pcj.SITUACAO situacao_processo_judicial
