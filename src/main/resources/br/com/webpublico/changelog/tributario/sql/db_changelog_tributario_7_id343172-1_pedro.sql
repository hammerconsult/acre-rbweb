...
(SELECT DISTINCT CAD.ID                                                           ID_CADASTRO,
                ...
                CASE
                    ...
                    END                           AS                              TIPOCADASTRO,
                EX.ID                                                             ID_EXERCICIO,
                PP.LANCAMENTO                     AS                              DATAPROTESTO,
                PP.CODIGO || '/' || EXPP.ANO      AS                              CODIGOPROCESSOPROTESTO,
...
FROM PARCELAVALORDIVIDA PVD
         ...
         LEFT JOIN ITEMPROCESSODEPROTESTO IPP ON PVD.ID = IPP.PARCELA_ID
         LEFT JOIN PROCESSODEPROTESTO PP ON IPP.PROCESSODEPROTESTO_ID = PP.ID
         LEFT JOIN EXERCICIO EXPP ON PP.EXERCICIO_ID = EXPP.ID
