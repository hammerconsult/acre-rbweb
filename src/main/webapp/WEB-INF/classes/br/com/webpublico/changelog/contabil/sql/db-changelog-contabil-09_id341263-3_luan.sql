...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE ESTORNO DA LIQUIDA&Ccedil;&Atilde;O DE RESTO A PAGAR</strong></td>
...
<tbody>
<tr>
<td style="text-align: center;"><strong>16. Saldo Anterior R$</strong></td>
<td style="text-align: center;"><strong>17. Valor da Nota R$</strong></td>
<td style="text-align: center;"><strong>18. Saldo Atual R$</strong></td>
</tr>
<tr>
...
<tbody>
<tr>
<td><strong>20. Hist&oacute;rico</strong></td>
</tr>
<tr>
<td>$HISTORICO</td>
</tr>
...
<tbody>
<tr>
<td style="border-right: 0px solid; text-align: left; width: 50%;"><strong>21. Assinaturas</strong></td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 156 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_RESTO_ESTORNO_LIQUIDACAO');
END;
