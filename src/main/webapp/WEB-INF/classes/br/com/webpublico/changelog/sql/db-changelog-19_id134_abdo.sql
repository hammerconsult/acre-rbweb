  CREATE OR REPLACE FORCE VIEW "VWCONSULTADEDEBITOS" ("CADASTRO_ID", "PESSOA_ID", "DIVIDA_ID", "CALCULO_ID", "VALORDIVIDA_ID", "PARCELA_ID", "SITUACAOPARCELA_ID", "SITUACAOPARCELA", "EXERCICIO_ID", "OPCAOPAGAMENTO_ID", "VALORORIGINAL", "VALORCORRECAO", "VALORJUROS", "VALORMULTA", "VALORHONORARIOS", "VALORIMPOSTO", "VALORTAXA", "VALORDESCONTO", "PARCELA", "PROMOCIONAL", "VALORPAGO", "DATAPAGAMENTO", "EMISSAO", "PROCESSOCALCULO", "QUANTIDADEIMPRESSOESDAM", "VENCIMENTO")
                                AS
