...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE ESTORNO DE PAGAMENTO DE RESTO A PAGAR</strong></td>
<td style="width: 25%;">$NUMERO_DOCUMENTO</td>
<td style="width: 25%;">$DATA_ESTORNO</td>
</tr>
</tbody>
</table>
<table style="border-collapse: collapse; width: 884px; height: 40px;" border="1" cellspacing="0">
...
<tbody>
<tr>
<td style="text-align: center;"><strong>17. Valor Pago R$</strong></td>
<td style="text-align: center;"><strong>18. Valor da Nota R$</strong></td>
<td style="text-align: center;"><strong>19. Saldo a&nbsp;Estornar R$</strong></td>
</tr>
<tr>
<td>$VALOR</td>
<td>$VALOR_ESTORNO</td>
...
<tbody>
<tr>
<td><strong>22. Reten&ccedil;&otilde;es Estornadas</strong></td>
</tr>
<tr>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 154 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_RESTO_ESTORNO_PAGAMENTO');
END;
