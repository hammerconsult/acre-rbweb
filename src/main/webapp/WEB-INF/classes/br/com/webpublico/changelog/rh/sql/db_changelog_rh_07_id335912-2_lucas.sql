CREATE
OR REPLACE FORCE VIEW "VWRHFICHAFINANCEIRA" ("ID_VINCULO", "ID_FICHA","CALCULADAEM", "EFETIVADAEM",  "ANO", "MES", "TIPOFOLHADEPAGAMENTO", "VERSAO","UNIDADEORGANIZACIONAL_ID", "RECURSOFP_ID", "VANTAGEM", "DESCONTO", "UM_TERCO_FERIAS", "RPPS", "BASERPPS", "REFERENCIARPPS", "INSS", "BASEINSS", "REFERENCIAINSS", "FGTS", "BASEFGTS", "REFERENCIAFGTS", "IRRF", "BASEIRRF", "REFERENCIAIRRF", "SALARIOMATERNIDADE", "BASESALARIOMATERNIDADE", "REFERENCIASALARIOMATERNIDADE", "SALARIOFAMILIA", "BASESALARIOFAMILIA", "REFERENCIASALARIOFAMILIA", "VALOROUTRASPREVIDENCIAS", "BASEOUTRASPREVIDENCIAS", "REFERENCIAOUTRASPREVIDENCIAS")
                            AS
SELECT ficha.vinculofp_id AS id_vinculo,
       ...
       folha.versao,
       ficha.unidadeOrganizacional_id,
       ficha.recursofp_id,
       ...
       (SELECT COALESCE(SUM(item.valorreferencia), 0)
        ...
        WHERE evento.id IN
          ...
          AND item.fichafinanceirafp_id = ficha.id
       )                  AS referenciaOutrasPrevidencias
