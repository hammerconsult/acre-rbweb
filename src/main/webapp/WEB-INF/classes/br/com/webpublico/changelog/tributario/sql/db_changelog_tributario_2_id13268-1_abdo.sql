    ...
    AS
      (SELECT COALESCE(CI.ID, COALESCE(CE.ID, COALESCE(CR.ID, COALESCE(PF.ID, PJ.ID)))) ID_CADASTRO,
        ...
        CI.ID ID_BCI,
        CI.INSCRICAOCADASTRAL INSCRICAO_BCI,
        CE.ID ID_BCE,
        CE.INSCRICAOCADASTRAL INSCRICAO_BCE,
        CR.ID ID_BCR,
        CR.NUMEROINCRA INSCRICAO_BCR,
