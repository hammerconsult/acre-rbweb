create or replace procedure proc_insere_pontuacao_1_atributo(p_identificacao in varchar,
                                                             p_atributo in varchar)
    is
    v_id_pontuacao numeric;
    v_id_atributo numeric;
begin
begin
select p.id into v_id_pontuacao from pontuacao p
...
into v_id_atributo
from atributo
where identificacao = p_atributo;
...
values (v_id_pontuacao, v_id_atributo);
end;
