  ...
  CREATE OR REPLACE FORCE VIEW VWHIERARQUIAADMINISTRATIVA (ID, SUPERIOR_ID, SUBORDINADA_ID, ENTIDADE_ID, CODIGO, DESCRICAO, EXERCICIO_ID, TIPOUNIDADE, TIPOADMINISTRACAO, ESFERADOPODER, CLASSIFICACAOUO, INICIOVIGENCIA, FIMVIGENCIA, ANO) AS
  WITH
    ...
    (
      SELECT
        ...
        ENT.ESFERADOPODER,
        ENT.CLASSIFICACAOUO,
        RAIZ.INICIOVIGENCIA AS INICIOVIGENCIA,
        RAIZ.FIMVIGENCIA,
        E.ANO
      FROM
  ...
  SELECT DISTINCT
    ...
    ESFERADOPODER,
    CLASSIFICACAOUO,
    trunc(INICIOVIGENCIA) as INICIOVIGENCIA,
    trunc(FIMVIGENCIA) as FIMVIGENCIA,
    ANO
  FROM
    REC
