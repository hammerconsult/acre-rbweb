CREATE OR REPLACE FORCE VIEW "WPPRODUCAO"."VWHIERARQUIADESPESAORC" ("ID", "ORGAO", "UNIDADE", "SUBACAO", "CONTA", "EXERCICIO", "UNIDADE_ID", "TIPOCONTADESPESA", "INICIOVIGENCIA", "FIMVIGENCIA")
              AS
  SELECT D.ID AS id,
    hoUo.CODIGO
    ||' - '
