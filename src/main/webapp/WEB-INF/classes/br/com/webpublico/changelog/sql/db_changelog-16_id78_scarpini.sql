  ...
  SELECT DISTINCT CADASTRO.ID AS CADASTRO_ID,
    ...
    round(PACOTE_CONSULTA_DE_DEBITOS.GETVALORCORRECAO( PVD.ID, extract(YEAR from pvd.vencimento)), 2)                             AS VALORCORRECAO,
    ...
    round(PACOTE_CONSULTA_DE_DEBITOS.GETVALORTIPOTRIBUTO(PVD.ID, 'IMPOSTO'), 2)                       AS VALORIMPOSTO,
    round(PACOTE_CONSULTA_DE_DEBITOS.GETVALORTIPOTRIBUTO(PVD.ID, 'TAXA'), 2)                          AS VALORTAXA,
