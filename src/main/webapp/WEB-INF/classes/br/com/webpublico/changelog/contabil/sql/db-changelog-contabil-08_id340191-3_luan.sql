...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE ESTORNO DA LIQUIDA&Ccedil;&Atilde;O</strong></td>
...
<tbody>
<tr>
<td style="text-align: center;"><strong>16. Valor Liquidado R$</strong></td>
<td style="text-align: center;"><strong>17. Valor da Nota R$</strong></td>
<td style="text-align: center;"><strong>18. Saldo a Estornar R$</strong></td>
</tr>
<tr>
<td>$VALOR</td>
<td>$VALOR_ESTORNO</td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 146 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_ESTORNO_LIQUIDACAO');
END;
