CREATE OR REPLACE FORCE EDITIONABLE VIEW "VWCONSULTADEDEBITOS" ("CADASTRO_ID", "PESSOA_ID",
       ...
       "OBSERVACAO", "PERMISSAOEMISSAODAM", "ULTIMAATUALIZACAOVALORES", "ISENTA_ACRESCIMOS",
       "DEBITOPROTESTADO", "DATAPROTESTO") AS
