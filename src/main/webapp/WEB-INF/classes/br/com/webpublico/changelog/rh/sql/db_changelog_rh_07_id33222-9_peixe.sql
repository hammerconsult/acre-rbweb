...
VALUES (hibernate_sequence.nextval, '1103', null, '13º Salário Maternidade - INSS',
        'return 0;',
        'return 0;',
        'return calculador.quantidadeMesesTrabalhadosAno();',
        'return false;',
        'VANTAGEM', 1,
        null, 'FOLHA', null, 'return calculador.salarioBase();', '13º Salário Mater. INSS', 1, 0, 'REFERENCIA', 0,
