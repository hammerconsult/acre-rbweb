...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE ESTORNO DE EMPENHO</strong></td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 144 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_ESTORNO_EMPENHO');
END;
