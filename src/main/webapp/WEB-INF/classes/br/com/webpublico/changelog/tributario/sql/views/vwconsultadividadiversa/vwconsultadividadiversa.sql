  create or replace force view vwconsultadividadiversa as
  select distinct
           ...
           dd.numerolancamento numeroProcesso,
           tdd.id idtipodividadiversa,
           tdd.descricao tipodividadiversa,
           dd.observacao,
       ...
       from calculodividadiversa dd
      inner join tipodividadiversa tdd on tdd.id = dd.tipodividadiversa_id
      inner join calculo c on c.id = dd.id
