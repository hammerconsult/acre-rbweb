...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 159 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_RESTO_EMPENHO');
END;
