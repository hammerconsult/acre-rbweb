delete from templatenfse where tipotemplate = 'PERMISSAO_ACESSO_EMPRESA';
insert into templatenfse values (hibernate_sequence.nextval, 'PERMISSAO_ACESSO_EMPRESA',
'<div style="padding: 20px; background-color:#f2f2f2;color:#555; font-family:''Helvetica Neue'',''Helvetica'',''Roboto'',''Calibri'',''Arial'',sans-serif">    <div style="padding:10px;font-size:1.1em;margin-top:5px;margin-bottom:5px;">        <h2>Prefeitura do Município $MUNICIPIO</h2>
    ...
    <div style="line-height:1.5em;text-align:center;background-color:#fff;padding:10px;font-size:1.1em;border:solid .5px #ddd;margin-top:5px;margin-bottom:5px;border-radius:7px">    <h3>Sua solicitação de acesso foi aprovada com sucesso.</h3>
	</div>
...
<div>      <table>
      ...
      <span style="font-size: 11px;">                </span>      </div>
	    ...
	    <div style="line-height:1.5em;text-align:left;background-color:#fff;padding:10px;font-size:1.1em;border:solid .5px #ddd;margin-top:5px;margin-bottom:5px;border-radius:7px">Agora você pode acessar o sistema de iss online e emitir, consultar e imprimir notas fiscais de serviço, bem como as declarações mensais de serviços e guias pela empresa.<br></div>
</div>');
