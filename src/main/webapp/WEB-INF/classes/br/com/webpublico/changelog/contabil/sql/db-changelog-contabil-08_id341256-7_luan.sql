...
<tbody>
<tr>
<td style="border-right: 0px solid; text-align: left; width: 50%;"><strong>18. Assinaturas</strong></td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 149 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_RECEITA_EXTRA');
END;
