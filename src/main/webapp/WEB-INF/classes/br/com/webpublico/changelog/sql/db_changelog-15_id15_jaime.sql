CREATE OR REPLACE FORCE VIEW "TESTE"."VWHIERARQUIAORCAMENTARIA" ("ID", "SUPERIOR_ID", "SUBORDINADA_ID", "ENTIDADE_ID", "CODIGO", "DESCRICAO", "EXERCICIO_ID", "TIPOUNIDADE", "TIPOADMINISTRACAO", "ESFERADOPODER", "CLASSIFICACAOUO", "INICIOVIGENCIA", "FIMVIGENCIA", "ANO")
AS
  SELECT raiz.id,
    raiz.superior_id,
    raiz.subordinada_id,
