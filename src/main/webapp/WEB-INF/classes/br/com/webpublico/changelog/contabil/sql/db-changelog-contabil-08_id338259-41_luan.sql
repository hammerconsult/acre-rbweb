...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE EMPENHO</strong></td>
<td style="width: 25%;">$NUMERO_EMPENHO</td>
<td style="width: 25%;">$DATA_EMPENHO</td>
</tr>
</tbody>
</table>
<table style="border-collapse: collapse; width: 884px; height: 40px;" border="1" cellspacing="0">
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 143 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_EMPENHO');
END;
