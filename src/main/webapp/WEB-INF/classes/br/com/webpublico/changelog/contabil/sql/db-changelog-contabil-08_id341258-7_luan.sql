...
<tr>
<td style="width: 50%; text-align: center;"><strong>NOTA DE DESPESA EXTRAOR&Ccedil;AMENT&Aacute;RIA<br /></strong></td>
...
<tbody>
<tr>
<td><strong>17. Conta Financeira</strong></td>
</tr>
<tr>
...
<tbody>
<tr>
<td><strong>18. ReceitasExtras</strong></td>
</tr>
<tr>
<td>$RECEITAS_EXTRAS</td>
</tr>
</tbody>
</table>
<table style="border-collapse: collapse; width: 884px; height: 40px;" border="1" cellspacing="0">
...
<tbody>
<tr>
<td style="border-right: 0px solid; text-align: left; width: 50%;"><strong>20. Assinaturas</strong></td>
...
BEGIN
update MODELODOCTOOFICIAL set conteudo = texto where TIPODOCTOOFICIAL_ID = (select tdo.id from TIPODOCTOOFICIAL tdo where tdo.CODIGO = 151 and tdo.MODULOTIPODOCTOOFICIAL = 'NOTA_PAGAMENTO_EXTRA');
END;
