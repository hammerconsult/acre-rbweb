...
EXTRACT(YEAR FROM PARAM_DATA_VENCIMENTO),0, PARAM_DATA_OPERACAO);
  END IF;
...
PARAM_SITUACAO_ID := GETULTIMASITUACAOPARCELA(PARAM_ID_PARCELA);
  ...
  ELSE
    ...
    PARAM_VALOR         := PARAM_VALOR                                   + ROUND(GETVALORJUROS(PARAM_DATA_OPERACAO, PARAM_PARCELA_ID,1), 2) +
ROUND( GETVALORMULTA(PARAM_DATA_OPERACAO,PARAM_PARCELA_ID,1), 2);
    PARAM_VALOR         := PARAM_VALOR                                   + ROUND(GETVALORCORRECAO(PARAM_PARCELA_ID,EXTRACT(YEAR
FROM PARAM_PARCELA_VENCIMENTO),1, PARAM_DATA_OPERACAO), 2);
