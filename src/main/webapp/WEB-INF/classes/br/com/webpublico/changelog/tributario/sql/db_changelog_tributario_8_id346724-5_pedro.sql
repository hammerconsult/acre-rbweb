...
begin
    select detentorarquivocomposicao_id bulk collect into idsDetentores from revisaocontrolelicenciamentoambiental;
    ...
    update revisaocontrolelicenciamentoambiental set detentorarquivocomposicao_id = null;
