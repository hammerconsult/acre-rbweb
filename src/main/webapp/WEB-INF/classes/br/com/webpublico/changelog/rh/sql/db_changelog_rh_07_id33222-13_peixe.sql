...
VALUES (hibernate_sequence.nextval, '1105', null, 'Abono de Permanência 13º Salário',
        'return 0;',
        'return 0;',
        'return calculador.quantidadeMesesTrabalhadosAno();',
        'return false;',
        'VANTAGEM', 1,
        null, 'FOLHA', null, 'return calculador.salarioBase();', 'Abono de Permanência 13º Salário', 1, 0, 'REFERENCIA', 0,
