    ...
    $.fn.dcDrilldown = function (options) {
        ...
        return this.each(function (options) {
            ...
            function setUpDrilldown() {
                ...
                var maxUl = $(objUl + '[rel="' + maxItems + '"]', this);
            ...
            function findMaxHeight(element) {
                ...
                var menuprinc = document.getElementById($dcDrilldownObj.id);
                var count = menuprinc.children.length;
                ...
                if (count > maxValue && defaults.linkType == 'breadcrumb') {
                    maxValue = count;
                }
        ...
        function actionDrillDown(element, wrapper, obj) {
            ...
            if (defaults.linkType == 'breadcrumb') {
                ...
                if (getNewBreadcrumb == defaults.defaultText) {
                    $('ul', $header).append('<li><a id="inicio" href="#" class="first">' + defaults.resetText + '</a></li>');
                } else {
