...
public enum TipoParametroNfse {
    ...
    HABILITA_PRIMEIRO_ACESSO("Habilita Cadastro de primeiro acesso ?", BooleanCancelamento.toStringArray()),
    QUANTIDADE_SOLICITACAO_CANCELAMENTO("Quantidade máxima de solicitações de cancelamento por nota", null),
    MENSAGEM_PRIMEIRO_ACESSO_DESABILITADO("Mensagem de bloqueio do primeiro acesso", null),
