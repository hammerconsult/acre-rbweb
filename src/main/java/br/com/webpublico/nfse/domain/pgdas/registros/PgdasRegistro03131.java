...
@Entity
@Audited
public class PgdasRegistro03131 extends SuperEntidade implements RegistroLinhaPgdas {
    ...
    public void criarLinha(AssistenteArquivoPGDAS assistente, List<String> pipes) {
        ...
        assistente.getArquivoPgdas().getRegistros03131().add(this);
    }
}
