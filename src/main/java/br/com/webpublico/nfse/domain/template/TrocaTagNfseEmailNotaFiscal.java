 ...
 */
public class TrocaTagNfseEmailNotaFiscal extends TrocaTagNfse {

    private static final Logger logger = LoggerFactory.getLogger(TrocaTagNfseEmailNotaFiscal.class);


    private NotaFiscal notaFiscal;

    public TrocaTagNfseEmailNotaFiscal(NotaFiscal notaFiscal, ConfiguracaoNfse configuracaoTributario) {
