...
public class PgdasRegistro01501 extends SuperEntidade implements RegistroLinhaPgdas {
    ...
    public void criarLinha(AssistenteArquivoPGDAS assistente, List<String> pipes) {
        ...
        assistente.getArquivoPgdas().getRegistros01501().add(this);
    }
}
