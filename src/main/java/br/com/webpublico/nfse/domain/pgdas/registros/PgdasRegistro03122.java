...
@Entity
@Audited
public class PgdasRegistro03122 extends SuperEntidade implements RegistroLinhaPgdas {
    ...
    public void criarLinha(AssistenteArquivoPGDAS assistente, List<String> pipes) {
        ...
        assistente.getArquivoPgdas().getRegistros03122().add(this);
    }
}
