...
public class SolicitacaoAcessoEmpresaAvaliacaoDTO implements Serializable {
...
//    private NfseUserDTO nfseUser;
    ...
    private Date avaliadaEm;
//    private NfseUserDTO nfseUserAvaliacao;
    private String motivoRejeicao;

    public SolicitacaoAcessoEmpresaAvaliacaoDTO() {
    }

    public SolicitacaoAcessoEmpresaAvaliacaoDTO(SolicitacaoAcessoEmpresa solicitacao, UsuarioWeb user) {
        ...
        this.solicitadaEm = solicitacao.getSolicitadaEm();
//        this.nfseUser = new NfseUserDTO(user);
        this.escritorioContabil = new EscritorioContabilDTO(solicitacao.getEscritorioContabil());
    }

    public SolicitacaoAcessoEmpresaAvaliacaoDTO(SolicitacaoAcessoEmpresa solicitacao) {
        this.cnpj = solicitacao.getCnpj();
        this.razaoSocial = solicitacao.getRazaoSocial();
        this.nomeFantasia = solicitacao.getNomeFantasia();
        this.situacao = solicitacao.getSituacao();
...
//    public NfseUserDTO getNfseUserAvaliacao() {
//        return nfseUserAvaliacao;
//    }
//
//    public void setNfseUserAvaliacao(NfseUserDTO nfseUserAvaliacao) {
