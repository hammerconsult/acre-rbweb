...
public class PgdasRegistro03130 extends SuperEntidade implements RegistroLinhaPgdas {
    ...
    public void criarLinha(AssistenteArquivoPGDAS assistente, List<String> pipes) {
        ...
        assistente.getArquivoPgdas().getRegistros03130().add(this);
    }
}
