...
public class PgdasRegistro01502 extends SuperEntidade implements RegistroLinhaPgdas {
    ...
    public void criarLinha(AssistenteArquivoPGDAS assistente, List<String> pipes) {
        ...
        assistente.getArquivoPgdas().getRegistros01502().add(this);
    }
}
