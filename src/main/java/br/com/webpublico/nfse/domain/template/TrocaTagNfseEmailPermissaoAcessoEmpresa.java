...
public class TrocaTagNfseEmailPermissaoAcessoEmpresa extends TrocaTagNfse {

    private static final Logger logger = LoggerFactory.getLogger(TrocaTagNfseEmailPermissaoAcessoEmpresa.class);
    private CadastroEconomico prestadorServicos;
    private Cidade municipio;
    private UsuarioWeb user;

    public TrocaTagNfseEmailPermissaoAcessoEmpresa(CadastroEconomico prestadorServicos, UsuarioWeb user, ConfiguracaoNfse configuracaoTributario) {
