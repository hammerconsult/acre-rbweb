...
@ManagedBean
@ViewScoped
public class ProcessoDebitoAtualizacaoMonetariaPesquisaGenerico extends ComponentePesquisaGenerico implements Serializable {
    ...
    public String montaCondicao() {
        ...
        condicao += " and tipo = '" + TipoProcessoDebito.ATUALIZACAO_MONETARIA.name() + "'";
