 ...
 * @author Munif
 */
public class GeraCadastroLinux {

    public static void main(String args[]) {
        try {
            String nomeUsuario = JOptionPane.showInputDialog("Digite o nome do usuario da maquina");
            ...
            FileWriter fw = new FileWriter("//home//" + nomeUsuario + "//NetBeansProjects//trunk//src//main//java//br//com//webpublico//geradores//" + classe.getSimpleName() + "Facade.java", false);
            fw.write("/*\n"
            ...
            for (AtributoMetadata amd : metadata.getAtributos()) {
                String atr = amd.getAtributo().getName();
                String atributoRoluto2 = atr.substring(0, 1).toUpperCase() + atr.substring(1);
                ManyToOne mto2 = amd.getAtributo().getAnnotation(ManyToOne.class);
                if (mto2 != null) {
                    fw.write("import br.com.webpublico.negocios." + atributoRoluto2 + "Facade;\n");
                }
            }
            ...
            for (AtributoMetadata amdt : metadata.getAtributos()) {
                String atrib = amdt.getAtributo().getName();
                String atribUP3 = atrib.substring(0, 1).toUpperCase() + atrib.substring(1);

                ManyToOne mtOne = amdt.getAtributo().getAnnotation(ManyToOne.class);
                if (mtOne != null) {
                    fw.write("@EJB\n");
                    fw.write("private " + atribUP3 + "Facade " + atrib + "Facade;\n");
                }
            }
            fw.write("@Override\n");
            ...
            for (AtributoMetadata amdt2 : metadata.getAtributos()) {
                String atrib = amdt2.getAtributo().getName();
                String atribUP = atrib.substring(0, 1).toUpperCase() + atrib.substring(1);

                ManyToOne mtOne = amdt2.getAtributo().getAnnotation(ManyToOne.class);
                if (mtOne != null) {
                    fw.write("public " + atribUP + "Facade get" + atribUP + "Facade() {\n");
                    fw.write("return " + atrib + "Facade;\n");
                    fw.write("}\n");
                }
            }
            ...
            //Gera lista.xhtml
            FileWriter fw2 = new FileWriter("//home//" + nomeUsuario + "//NetBeansProjects//trunk//src//main//java//br//com//webpublico//geradores//lista.xhtml", false);
            ...
            FileWriter fw3 = new FileWriter("//home//" + nomeUsuario + "//NetBeansProjects//trunk//src//main//java//br//com//webpublico//geradores//visualizar.xhtml", false);
            ...
            //Gera edita.xhtml
            FileWriter fw4 = new FileWriter("//home//" + nomeUsuario + "//NetBeansProjects//trunk//src//main//java//br//com//webpublico//geradores//edita.xhtml", false);
            ...
            for (AtributoMetadata a : metadata.getAtributos()) {
                ...
                int tamanho = 70;
//                if (metadata.getEntidade().isAnnotationPresent(Size.class)) {
...
//                }
            ...
            //Gera Controlador
            FileWriter fw5 = new FileWriter("//home//" + nomeUsuario + "//NetBeansProjects//trunk//src//main//java//br//com//webpublico//geradores//" + classe.getSimpleName() + "Controlador.java", false);
            fw5.write("/*\n"
                    + " * Codigo gerado automaticamente em " + new Date() + "\n"
            ...
            for (AtributoMetadata a4 : metadata.getAtributos()) {
                ...
                if (mto4 != null) {
                    ...
                    fw5.write("for (" + atributoUP4 + " object : " + nomeControle + "Facade.get" + atributoUP4 + "Facade.lista()) {\n");
                    fw5.write("toReturn.add(new SelectItem(object, object.toString()));\n");
                    fw5.write("}\n");
                    ...
                    //abaixo
                    fw5.write("converter" + atributoUP4 + " = new ConverterGenerico(" + atributoUP4 + ".class, " + nomeControle + "Facade.get" + atributoUP4 + "Facade());\n");
                    fw5.write("}\n");
