...
public class AnaliseBalanceteContabil extends AssistenteBarraProgresso {
    ...
    public AnaliseBalanceteContabil() {

    }

    public AnaliseBalanceteContabil(LancamentoContabil lancamento, Conta contaCredito, PesquisaLCP.DebitoCredito debitoCredito) {
