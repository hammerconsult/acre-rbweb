 ...
 */
public class VOConsultaDividaAtivaComparator implements Comparator<VOConsultaDividaAtiva> {

    @Override
    public int compare(VOConsultaDividaAtiva o1, VOConsultaDividaAtiva o2) {
