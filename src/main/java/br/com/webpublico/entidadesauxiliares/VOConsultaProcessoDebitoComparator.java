 ...
 */
public class VOConsultaProcessoDebitoComparator implements Comparator<VOConsultaProcessoDebito> {

    @Override
    public int compare(VOConsultaProcessoDebito o1, VOConsultaProcessoDebito o2) {
