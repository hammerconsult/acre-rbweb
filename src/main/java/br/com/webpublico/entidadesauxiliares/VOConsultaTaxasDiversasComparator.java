 ...
 */
public class VOConsultaTaxasDiversasComparator implements Comparator<VOConsultaTaxasDiversas> {

    @Override
    public int compare(VOConsultaTaxasDiversas o1, VOConsultaTaxasDiversas o2) {
