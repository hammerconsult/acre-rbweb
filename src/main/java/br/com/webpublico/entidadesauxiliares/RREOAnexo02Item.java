...
public class RREOAnexo02Item {
    ...
    private BigDecimal despesaEmpenhadasAteOBimestrePercentualTotal;
    private BigDecimal despesaLiquidadaAteOBimestrePercentual;
    private BigDecimal inscritasEmRestosAPagar;
    private BigDecimal saldoALiquidar;
    private Integer nivel;
    private Integer numeroLinhaNoXLS;

    public RREOAnexo02Item() {
        dotacaoInicial = BigDecimal.ZERO;
        dotacaoAtualizada = BigDecimal.ZERO;
        despesaEmpenhadasNoBimestre = BigDecimal.ZERO;
        despesaEmpenhadasAteOBimestre = BigDecimal.ZERO;
        despesaLiquidadaNoBimestre = BigDecimal.ZERO;
        despesaLiquidadaAteOBimestre = BigDecimal.ZERO;
        despesaLiquidadaAteOBimestrePercentualTotal = BigDecimal.ZERO;
        despesaEmpenhadasAteOBimestrePercentualTotal = BigDecimal.ZERO;
        despesaLiquidadaAteOBimestrePercentual = BigDecimal.ZERO;
        inscritasEmRestosAPagar = BigDecimal.ZERO;
        saldoALiquidar = BigDecimal.ZERO;
    }
    ...
    public BigDecimal getInscritasEmRestosAPagar() {
        return inscritasEmRestosAPagar;
    }

    public void setInscritasEmRestosAPagar(BigDecimal inscritasEmRestosAPagar) {
        this.inscritasEmRestosAPagar = inscritasEmRestosAPagar;
    }
    ...
    public BigDecimal getDespesaEmpenhadasAteOBimestrePercentualTotal() {
        return despesaEmpenhadasAteOBimestrePercentualTotal;
    }

    public void setDespesaEmpenhadasAteOBimestrePercentualTotal(BigDecimal despesaEmpenhadasAteOBimestrePercentualTotal) {
        this.despesaEmpenhadasAteOBimestrePercentualTotal = despesaEmpenhadasAteOBimestrePercentualTotal;
    }
