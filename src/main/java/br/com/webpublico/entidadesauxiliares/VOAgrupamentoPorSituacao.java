 ...
 */
public class VOAgrupamentoPorSituacao implements Serializable {
    ...
    public VOAgrupamentoPorSituacao() {
    ...
    public VOAgrupamentoPorSituacao(Object[] obj) {
        this.preencher(obj);
    }

    public void preencher(Object[] obj) {
        this.situacaoParcela = ((String) obj[0]);
