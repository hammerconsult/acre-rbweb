 ...
 */
public class VOConsultaTaxasDiversas extends AbstractVOConsultaLancamento {

    private Integer numeroProcesso;
    private String observacao;

    public VOConsultaTaxasDiversas() {
    }

    public VOConsultaTaxasDiversas(Object[] obj) {
        preencheObjeto(obj);
    }
    ...
    public void preencheObjeto(Object[] resultado) {
        ...
        this.observacao = (String) resultado[26];
        this.setBairro((String) resultado[27]);
        this.setLogradouro((String) resultado[28]);
        this.setNumeroEndereco((String) resultado[29]);
        this.setComplemento((String) resultado[30]);
        this.setCep((String) resultado[31]);
    }
