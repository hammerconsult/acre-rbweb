 ...
 */
public class VOConsultaFiscalizacaoSecretariaComparator implements Comparator<VOConsultaFiscalizacaoSecretaria> {
    @Override
    public int compare(VOConsultaFiscalizacaoSecretaria o1, VOConsultaFiscalizacaoSecretaria o2) {
        int i = o1.getResultadoParcela().getCadastro().compareTo(o2.getResultadoParcela().getCadastro());
        if (i != 0) {
            return i;
        }
        i = o1.getNumeroAutoInfracao().compareTo(o2.getNumeroAutoInfracao());
        if (i != 0) {
            return i;
        }
