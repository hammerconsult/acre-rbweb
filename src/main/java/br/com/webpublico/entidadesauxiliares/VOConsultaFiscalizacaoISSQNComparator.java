 ...
 */
public class VOConsultaFiscalizacaoISSQNComparator implements Comparator<VOConsultaFiscalizacaoISSQN> {
    @Override
    public int compare(VOConsultaFiscalizacaoISSQN o1, VOConsultaFiscalizacaoISSQN o2) {
