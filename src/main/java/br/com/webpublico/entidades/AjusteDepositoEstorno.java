...
public class AjusteDepositoEstorno extends SuperEntidade implements EntidadeContabil, IGeraContaAuxiliar {
    ...
    public TreeMap getMapContaAuxiliarDetalhadaSiconfi(TipoContaAuxiliar tipoContaAuxiliar, ContaContabil contaContabil) {
        switch (tipoContaAuxiliar.getCodigo()) {
            ...
            case "95":
                return UtilGeradorContaAuxiliar.gerarContaAuxiliarDetalhada5(getUnidadeOrganizacional(), ajusteDeposito.getContaDeDestinacao(), ajusteDeposito.getFonteDeRecurso().getExercicio());
        }
        return null;
    }
        ...
        switch (tipoContaAuxiliar.getCodigo()) {
            ...
            case "95":
                return UtilGeradorContaAuxiliar.gerarContaAuxiliar5(getUnidadeOrganizacional(),
                    ajusteDeposito.getContaDeDestinacao());
        }
        return null;
    }
