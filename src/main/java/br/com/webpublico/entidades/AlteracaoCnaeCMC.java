...
@Entity
@Audited
public class AlteracaoCnaeCMC extends SuperEntidade {
    @Id
    ...
    private CNAE cnae;
    @Transient
    private transient String descricaoCnae;

    public AlteracaoCnaeCMC() {
    }
    ...
    public boolean equals(Object o) {
        ...
        AlteracaoCnaeCMC that = (AlteracaoCnaeCMC) o;
