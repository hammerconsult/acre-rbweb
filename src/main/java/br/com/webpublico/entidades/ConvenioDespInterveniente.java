...
public class ConvenioDespInterveniente implements Serializable {
    ...
    public ConvenioDespInterveniente() {
    ...
    public String toString() {
        return "br.com.webpublico.entidades.ConvenioDespInterveniente[ id=" + id + " ]";
    }
}
