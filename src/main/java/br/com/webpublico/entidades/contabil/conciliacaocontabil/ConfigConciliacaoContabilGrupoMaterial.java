...
@Entity
@Audited
@Etiqueta("Configuração de Conciliação Contábil - Grupo de Material")
@Table(name = "CONFIGCONCCONTABILGRUPOM")
public class ConfigConciliacaoContabilGrupoMaterial extends SuperEntidade implements Serializable {
