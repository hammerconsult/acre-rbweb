 ...
 */
@Entity
@Etiqueta("Movimento Grupo Bens Intangíveis")
@Table(name = "MOVIMENTOGRUPOBENSINTANG")
public class MovimentoGrupoBensIntangiveis extends SuperEntidade implements Serializable {
    ...
    @Enumerated(EnumType.STRING)
    @Etiqueta("Operação")
    private TipoOperacaoBensIntangiveis operacao;
    ...
    public MovimentoGrupoBensIntangiveis() {
    ...
    public TipoOperacaoBensIntangiveis getOperacao() {
        return operacao;
    }

    public void setOperacao(TipoOperacaoBensIntangiveis operacao) {
