...
@Entity
@Audited
public class SituacaoEmissaoDebitoLicenciamentoAmbiental extends SuperEntidade implements Serializable {
    ...
    public SituacaoEmissaoDebitoLicenciamentoAmbiental() {
        super();
    }

    public SituacaoEmissaoDebitoLicenciamentoAmbiental(AssuntoLicenciamentoAmbiental assuntoLicenciamentoAmbiental) {
        super();
