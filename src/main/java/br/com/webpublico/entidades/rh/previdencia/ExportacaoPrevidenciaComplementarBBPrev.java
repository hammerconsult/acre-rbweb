...
@Audited
@Entity
@Table(name = "EXPORTPREVCOMPLEMBBPREV")
public class ExportacaoPrevidenciaComplementarBBPrev extends SuperEntidade implements Serializable {
    ...
    private TipoEnvioBBPrev tipoEnvio;
    ...
    public TipoEnvioBBPrev getTipoEnvio() {
        return tipoEnvio;
    }

    public void setTipoEnvio(TipoEnvioBBPrev tipoEnvio) {
