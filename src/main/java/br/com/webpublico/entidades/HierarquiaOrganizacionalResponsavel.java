...
@Entity
@Audited
@Table(name="HIERARQUIAORGRESP")
public class HierarquiaOrganizacionalResponsavel implements Serializable {
    ...
    public HierarquiaOrganizacionalResponsavel() {
    ...
    public boolean equals(Object o) {
        ...
        HierarquiaOrganizacionalResponsavel other = (HierarquiaOrganizacionalResponsavel) o;
