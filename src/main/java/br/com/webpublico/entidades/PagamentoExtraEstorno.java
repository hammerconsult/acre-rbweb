...
public class PagamentoExtraEstorno extends SuperEntidadeContabilGerarContaAuxiliar implements EntidadeContabil {
    ...
    public GeradorContaAuxiliarDTO gerarContaAuxiliarDTO(ParametroEvento.ComplementoId complementoId) {
        return new GeradorContaAuxiliarDTO(getUnidadeOrganizacional(), pagamentoExtra.getContaDeDestinacao(), getExercicio());
    }
}
