...
@Entity
@Audited
@Etiqueta("Tarefa do Auditor Fiscal")
public class TarefaAuditorFiscal implements Serializable {
    ...
    public boolean equals(Object object) {
        if (!(object instanceof TarefaAuditorFiscal)) {
            return false;
        }
