...
@Entity
@Audited
public class ParametroAlvaraImediatoCoibicao extends SuperEntidade implements RespostaFormularioCampo {

    @Id
    @GeneratedValue
    private Long id;
    @ManyToOne
    private ParametroAlvaraImediato parametro;
    @Etiqueta("Campo")
    @Obrigatorio
    @ManyToOne
    ...
    public ParametroAlvaraImediato getParametro() {
        return parametro;
    }

    public void setParametro(ParametroAlvaraImediato parametro) {
