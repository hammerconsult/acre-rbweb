...
@Etiqueta("Transferência de Bens Imóveis")
public class TransfBensImoveis extends SuperEntidadeContabilFinanceira implements Serializable, EntidadeContabil, IGeraContaAuxiliar {
    ...
    @Pesquisavel
    @Enumerated(EnumType.STRING)
    private TipoOperacaoBensImoveis operacaoOrigem;
    @Etiqueta("Operação de Destino")
    @Obrigatorio
    @Pesquisavel
    @Enumerated(EnumType.STRING)
    private TipoOperacaoBensImoveis operacaoDestino;
    ...
    public TipoOperacaoBensImoveis getOperacaoOrigem() {
        return operacaoOrigem;
    }

    public void setOperacaoOrigem(TipoOperacaoBensImoveis operacaoOrigem) {
        this.operacaoOrigem = operacaoOrigem;
    }

    public TipoOperacaoBensImoveis getOperacaoDestino() {
        return operacaoDestino;
    }

    public void setOperacaoDestino(TipoOperacaoBensImoveis operacaoDestino) {
