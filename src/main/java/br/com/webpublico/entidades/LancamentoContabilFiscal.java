...
@Audited
public class LancamentoContabilFiscal implements Serializable, Comparable<LancamentoContabilFiscal> {
    ...
    public LancamentoContabilFiscal() {
        zeraValores();
        this.nfse = false;
    }
    ...
    @Override
    public int compareTo(LancamentoContabilFiscal o) {
        try {
            ...
            if (retorno == 0) {
                retorno = this.getSequencia().compareTo(o.getSequencia());
            }
            if (retorno == 0) {
