...
public class EstornoLibCotaFinanceira extends SuperEntidadeContabilFinanceira {
    ...
    public GeradorContaAuxiliarDTO gerarContaAuxiliarDTO(ParametroEvento.ComplementoId complementoId) {
        if (ParametroEvento.ComplementoId.CONCEDIDO.equals(complementoId)) {
            return new GeradorContaAuxiliarDTO(getUnidadeOrganizacional(),
                liberacao.getContaDeDestinacao(), liberacao.getExercicio());
        } else if (ParametroEvento.ComplementoId.RECEBIDO.equals(complementoId)) {
            return new GeradorContaAuxiliarDTO(liberacao.getSolicitacaoCotaFinanceira().getUnidadeOrganizacional(),
                liberacao.getSolicitacaoCotaFinanceira().getContaDeDestinacao(), liberacao.getExercicio());
        }
        return null;
    }
}
