...
@Etiqueta("Acesso a Cargo de Comissão")
public class CargoConfianca implements Serializable, ValidadorVigenciaFolha {
    ...
    @OneToMany(cascade = CascadeType.ALL, mappedBy = "cargoConfianca", orphanRemoval = true)
