 ...
 */
@Etiqueta(value = "Ordem Bancária/Transfêrencia Mesma Unidade")
@GrupoDiagrama(nome = "Contabil")
@Audited
@Entity
@Table(name = "BORDEROTRANSFMESMAUNIDADE")
public class BorderoTransferenciaMesmaUnidade implements Serializable {
    ...
    @Pesquisavel
    @Tabelavel
    @Etiqueta("Ordem Bancnária")
    private Bordero bordero;
    @ManyToOne
    @Pesquisavel
    @Tabelavel
    @Etiqueta("Transferência Financeira Mesma Unidade")
    @JoinColumn(name = "TRANSFMESMAUNIDADE_ID")
    ...
    public BorderoTransferenciaMesmaUnidade() {
        valor = BigDecimal.ZERO;
        criadoEm = System.nanoTime();
    }

    public BorderoTransferenciaMesmaUnidade(Bordero bordero, TransferenciaMesmaUnidade transferenciaMesmaUnidade) {
    ...
    public String toString() {
        return transferenciaMesmaUnidade.toString();
    }
}
