...
@Etiqueta("Transferência de Bens Móveis")
public class TransfBensMoveis extends SuperEntidadeContabilFinanceira implements Serializable, EntidadeContabil, IGeraContaAuxiliar {
    ...
    public void gerarHistoricoRazao() {
        ...
        if (this.getEventoContabilDestino() != null && this.getEventoContabilDestino().getClpHistoricoContabil() != null) {
            historicoEvento = "Evento Contábil Recebido: " + this.getEventoContabilDestino().getClpHistoricoContabil().toString();
        }
    ...
    public String getReferenciaArquivoPrestacaoDeContas() {
        return numero + " - " + grupoBemDestino.toString();
    }
