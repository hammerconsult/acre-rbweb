...
@Entity
@Audited
@Table(name = "CONSTRUCAO_VALORATRIBUTO")
public class CaracteristicasConstrucao extends SuperEntidade {
    ...
    public boolean equals(Object o) {
        ...
        CaracteristicasConstrucao that = (CaracteristicasConstrucao) o;

        if (construcao != null ? !construcao.equals(that.construcao) : that.construcao != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (construcao != null ? construcao.hashCode() : 0);
