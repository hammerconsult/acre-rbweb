...
@Audited
@Etiqueta("Configuração de Suprimento de Fundos")
@Inheritance(strategy = InheritanceType.JOINED)
public class ConfigSuprimentoDeFundos extends ConfiguracaoEvento implements Serializable {
    ...
    public ConfigSuprimentoDeFundos() {
        super();
    }
