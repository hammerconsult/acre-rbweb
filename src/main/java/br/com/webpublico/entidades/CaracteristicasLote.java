...
@Entity
@Audited
@Table(name = "LOTE_VALORATRIBUTO")
public class CaracteristicasLote extends SuperEntidade {
    ...
    public boolean equals(Object o) {
        ...
        CaracteristicasLote that = (CaracteristicasLote) o;

        if (lote != null ? !lote.equals(that.lote) : that.lote != null) return false;
