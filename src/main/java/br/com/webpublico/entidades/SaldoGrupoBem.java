...
@Etiqueta("Saldo Bens Móveis")
public class SaldoGrupoBem extends SuperEntidade {
    ...
    public SaldoGrupoBem() {
        super();
        this.credito = new BigDecimal(BigInteger.ZERO);
        this.debito = new BigDecimal(BigInteger.ZERO);
    }

    public SaldoGrupoBem(Date dataSaldo, BigDecimal credito, BigDecimal debito, UnidadeOrganizacional unidadeOrganizacional, TipoGrupo tipoGrupo, NaturezaTipoGrupoBem naturezaTipoGrupoBem, GrupoBem grupoBem) {
