...
public class AnulacaoLiberacao implements Serializable {
    ...
    public AnulacaoLiberacao() {
    }

    public AnulacaoLiberacao(AnulacaoORC anulacaoORC, LiberacaoFonteDespesaOrc liberacaoFonteDespesaOrc) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AnulacaoLiberacao)) {
            return false;
        }
        AnulacaoLiberacao other = (AnulacaoLiberacao) object;
    ...
    public String toString() {
        return "Anulação: " + anulacaoORC + " - " + liberacaoFonteDespesaOrc;
    }
}
