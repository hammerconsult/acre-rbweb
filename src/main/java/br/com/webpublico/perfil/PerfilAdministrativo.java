 ...
 */
public class PerfilAdministrativo extends Perfil {
    ...
    public PerfilAdministrativo() {
        ...
        modificaAtributo("oEstado", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("iEstado", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("oCidade", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("iCidade", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("oBairro", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("iBairro", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("oLogradouro", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("iLogradouro", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("oTipoEndereco", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("iTipoEndereco", Boolean.TRUE, Boolean.TRUE);
        ...
        modificaAtributo("oTipoEmpresa", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("iTipoEmpresa", Boolean.TRUE, Boolean.TRUE);
        modificaAtributo("mTipoEmpresa", Boolean.TRUE, Boolean.TRUE);
    ...
    public Boolean validarPessoa(Pessoa p) throws Exception {
        ...
        if (!p.getEmail().trim().isEmpty() && !p.getEmail().contains("@")) {
            constrole = false;
        ...
        if (!p.getHomePage().trim().isEmpty() && !p.getHomePage().contains("www.")) {
            constrole = false;
