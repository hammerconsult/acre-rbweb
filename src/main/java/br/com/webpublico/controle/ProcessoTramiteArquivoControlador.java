...
@ManagedBean
@SessionScoped
public class ProcessoTramiteArquivoControlador extends SuperControladorCRUD implements Serializable {
...
//    @ManagedProperty(name = "processoControlador", value = "#{processoControlador}")
//    private ProcessoControlador processoControlador;

    public ProcessoTramiteArquivoControlador() {
    ...
    public void selecionarTemp(ActionEvent evento) {
        operacao = Operacoes.EDITAR;
...
//            //  FacesContext.getCurrentInstance().getExternalContext().redirect(pathReal + "/faces/tributario/cadastromunicipal/processo/edita.xhtml");
//        } catch (Exception e) {
//            e.printStackTrace();
...
//    public String salvarTemp() {
//        FacesContext facesContext = FacesContext.getCurrentInstance();
//        ExternalContext externalContext = facesContext.getExternalContext();
//        ServletContext servletContext = (ServletContext) externalContext.getContext();
//        String pathReal = servletContext.getContextPath();
//        try {
//            ((Tramite) selecionado).getArquivos().addAll(tramiteFacade.salvarTemp(fileUploadEvents));
//        } catch (Exception e) {
//            e.printStackTrace();
//            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Ops!", "Problemas ao Salvar"));
//        }
