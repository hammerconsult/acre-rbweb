...
@ManagedBean
@ViewScoped
public class PessoaFisicaPortalPesquisaGenericaControlador extends ComponentePesquisaGenerico implements Serializable {
    ...
    public void getCampos() {
        ...
        itens.add(new ItemPesquisaGenerica("p", "Perfil", PerfilEnum.class, true, false));
    ...
    public String getComplementoQuery() {
        ...
        return " inner join obj.perfis as p " + innerJoin + " where " + where + montaCondicao() + montaOrdenacao();
    }
