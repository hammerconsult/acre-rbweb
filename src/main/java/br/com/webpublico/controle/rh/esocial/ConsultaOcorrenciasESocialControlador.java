...
@ManagedBean(name = "consultaOcorrenciasESocialControlador")
@ViewScoped
...
public class ConsultaOcorrenciasESocialControlador {
    private static final Logger logger = LoggerFactory.getLogger(ConsultaOcorrenciasESocialControlador.class);
    ...
    private List<ContratoFP> itemContratoFPS2190;
    private List<ContratoFP> itemContratoFPS2205;
    private Map<ContratoFP, Date> mapItemContratoFPS2206;
    private List<ContratoFP> itemContratoFPS2200;
    private ContratoFP[] itemContratoFPS2200Selecionado;
    ...
    public List<ContratoFP> getItemContratoFPS2190() {
        return itemContratoFPS2190;
    }

    public void setItemContratoFPS2190(List<ContratoFP> itemContratoFPS2190) {
    ...
    public List<ContratoFP> getItemContratoFPS2205() {
        return itemContratoFPS2205;
    }

    public void setItemContratoFPS2205(List<ContratoFP> itemContratoFPS2205) {
    ...
    public List<ContratoFP> getItemContratoFPS2200() {
        return itemContratoFPS2200;
    }

    public void setItemContratoFPS2200(List<ContratoFP> itemContratoFPS2200) {
        this.itemContratoFPS2200 = itemContratoFPS2200;
    }

    public ContratoFP[] getItemContratoFPS2200Selecionado() {
        return itemContratoFPS2200Selecionado;
    }

    public void setItemContratoFPS2200Selecionado(ContratoFP[] itemContratoFPS2200Selecionado) {
...
//                        hierarquiaOrganizacional.getSubordinada().getEntidade());
    ...
    public void enviarS1010() {
        try {
            ...
            itemEventoFPS1010.forEach(evento -> {
                evento.setTipoOperacaoESocial(tipoOperacaoESocialS1010);
            });
            ConfiguracaoEmpregadorESocial config = configuracaoEmpregadorESocialFacade.recuperarPorEntidade(empregador);
            configuracaoEmpregadorESocialFacade.enviarS1010(config, itemEventoFPS1010);
    ...
    private void validarRegistrosAdicionadosS2200(ContratoFP[] vinculo) {
        ValidacaoException ve = new ValidacaoException();
    ...
    public void enviarS2200() {
        try {
            ...
            ArrayList<ContratoFP> contratos = Lists.newArrayList(itemContratoFPS2200Selecionado);
    ...
    public void adicionarContratoFP(String tipoArquivoESocial) {
        try {
            if (TipoArquivoESocial.S2205.equals(TipoArquivoESocial.valueOf(tipoArquivoESocial))) {
                ...
                itemContratoFPS2205.add(contratoFP);
            }
            if (TipoArquivoESocial.S2200.equals(TipoArquivoESocial.valueOf(tipoArquivoESocial))) {
                ...
                itemContratoFPS2200.add(contratoFP);
            }
    ...
    private void validarContratoAdicionado(List<ContratoFP> lista) {
        ValidacaoException ve = new ValidacaoException();
        if (lista.contains(contratoFP)) {
            ve.adicionarMensagemDeOperacaoNaoRealizada("Contrato já adicionado.");
        }
        ve.lancarException();
    }
    ...
    private void validarPesquisaEnvioEventoS1207() {
        ...
        if (registroEventoEsocialS1207.getTipoFolhaDePagamento() == null) {
    ...
    public void adicionarVinculo(String tipoEventoString) {
        RegistroEventoEsocial registroEventoEsocial = getRegistroEventoEsocialPorTipo(TipoArquivoESocial.valueOf(tipoEventoString));
        try {
            validarPesquisaEnvioEvento(registroEventoEsocial);
            List<VinculoFPEventoEsocial> item = getVinculoComFolhaEfetivadaNaCompetenciaS1202();
            if (item != null) {
    ...
    public void enviarEventoS3000() {
        try {
            validarBuscaEmpregador();
            validarEnvioEvento(itemExclusao);
            ...
            s3000.setItemExclusao(itemExclusao);
    ...
    public void marcarTodosItensS2200() {
        if (marcarTodosContratos2200) {
            itemContratoFPS2200Selecionado = itemContratoFPS2200.toArray(new ContratoFP[0]);
        } else {
    ...
    public List<SelectItem> getTiposArquivoEsocial() {
        ...
        for (TipoArquivoESocial value : TipoArquivoESocial.values()) {
            if (!getEventosPrimeiraFase().contains(value)) {
