 ...
 * @author Edi
 */
@ManagedBean(name = "oCCContaDespesaControlador")
@ViewScoped
@URLMappings(mappings = {
        @URLMapping(id = "novo-occ-conta-despesa", pattern = "/occ/conta-despesa/novo/", viewId = "/faces/financeiro/origemcontacontabil/contadespesa/edita.xhtml"),
        @URLMapping(id = "editar-occ-conta-despesa", pattern = "/occ/conta-despesa/editar/#{oCCContaDespesaControlador.id}/", viewId = "/faces/financeiro/origemcontacontabil/contadespesa/edita.xhtml"),
        @URLMapping(id = "ver-occ-conta-despesa", pattern = "/occ/conta-despesa/ver/#{oCCContaDespesaControlador.id}/", viewId = "/faces/financeiro/origemcontacontabil/contadespesa/visualizar.xhtml"),
        @URLMapping(id = "listar-occ-conta-despesa", pattern = "/occ/conta-despesa/listar/", viewId = "/faces/financeiro/origemcontacontabil/contadespesa/listar.xhtml"),})
public class OCCContaDespesaControlador extends PrettyControlador<OCCConta> implements Serializable, CRUD {
    ...
    public OCCContaDespesaControlador() {
    ...
    @URLAction(mappingId = "novo-occ-conta-despesa", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    @Override
    public void novo() {
        super.novo();
        selecionado.setInicioVigencia(sistemaControlador.getDataOperacao());
        setEntidadeOCC(EntidadeOCC.CONTADESPESA);
        origenscc = new ArrayList<>();
    }

    @URLAction(mappingId = "ver-occ-conta-despesa", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    @Override
    public void ver() {
        super.ver();
        recuperaEditarVer();
    ...
    @URLAction(mappingId = "editar-occ-conta-despesa", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    @Override
    public void editar() {
        super.editar();
        recuperaEditarVer();
    ...
    public List<Conta> completaContaDespesa(String parte) {
        if (sistemaControlador != null) {
            return origemOCCFacade.getContaFacade().listaFiltrandoContaDespesa(parte.trim(), tipoContaDespesa, sistemaControlador.getExercicioCorrente());
        }
        return null;
    }
