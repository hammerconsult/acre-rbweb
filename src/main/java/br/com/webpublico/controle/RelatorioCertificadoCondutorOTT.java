...
@ManagedBean(name = "relatorioCertificadoCondutorOTT")
@ViewScoped
@URLMappings(mappings = {
    @URLMapping(id = "relatorio-certificado-autorizacao-condutor", pattern = "/relatorio/certificado-autorizacao-condutor/", viewId = "/faces/tributario/rbtrans/relatorio/relatorio-certificado-condutor.xhtml"),
})
public class RelatorioCertificadoCondutorOTT implements Serializable {
    ...
    @URLAction(mappingId = "relatorio-certificado-autorizacao-condutor", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    public void relatorioCertificadoCondutor() {
        limparCampos();
        filtroOtt.setTipoRelatorio(TipoRelatorioCertificado.RELATORIO_CONDUTOR_OTT);
    }

    public RelatorioCertificadoCondutorOTT() {
    }
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setNomeRelatorio("Relatório de Certificados de Condutores de OTT");
            ...
            dto.setApi("tributario/relatorio-certificado-autorizacao/");
