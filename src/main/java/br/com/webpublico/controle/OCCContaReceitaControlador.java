 ...
 * @author Edi
 */
@ManagedBean(name = "oCCContaReceitaControlador")
@ViewScoped
@URLMappings(mappings = {
    @URLMapping(id = "novo-occ-conta-receita", pattern = "/occ/conta-receita/novo/", viewId = "/faces/financeiro/origemcontacontabil/contareceita/edita.xhtml"),
    @URLMapping(id = "editar-occ-conta-receita", pattern = "/occ/conta-receita/editar/#{oCCContaReceitaControlador.id}/", viewId = "/faces/financeiro/origemcontacontabil/contareceita/edita.xhtml"),
    @URLMapping(id = "ver-occ-conta-receita", pattern = "/occ/conta-receita/ver/#{oCCContaReceitaControlador.id}/", viewId = "/faces/financeiro/origemcontacontabil/contareceita/visualizar.xhtml"),
    @URLMapping(id = "listar-occ-conta-receita", pattern = "/occ/conta-receita/listar/", viewId = "/faces/financeiro/origemcontacontabil/contareceita/listar.xhtml"),
})
public class OCCContaReceitaControlador extends PrettyControlador<OCCConta> implements Serializable, CRUD {
    ...
    private List<OrigemContaContabil> filtros;
    private List<Conta> listConta;
    private Conta[] arrayConta;
    private String palavra;
    private TiposCredito tiposCredito;

    public OCCContaReceitaControlador() {
        super(OCCConta.class);
    }

    public List<OrigemContaContabil> getFiltros() {
        return filtros;
    }

    public void setFiltros(List<OrigemContaContabil> filtros) {
    ...
    @URLAction(mappingId = "novo-occ-conta-receita", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    @Override
    public void novo() {
        super.novo();
        selecionado.setInicioVigencia(sistemaControlador.getDataOperacao());
        setEntidadeOCC(EntidadeOCC.CONTARECEITA);
        origenscc = new ArrayList<>();

    }

    @URLAction(mappingId = "ver-occ-conta-receita", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    @Override
    public void ver() {
        super.ver();
        recuperaEditarVer();
    ...
    @URLAction(mappingId = "editar-occ-conta-receita", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    @Override
    public void editar() {
        super.editar();
        recuperaEditarVer();
    ...
    public void removeConta(OrigemContaContabil occ) {
    ...
    public void recuperaEditarVer() {
        OCCConta occ = (OCCConta) selecionado;
    ...
    public List<Conta> completaContaReceita(String parte) {
        if (sistemaControlador != null) {
            return origemOCCFacade.getContaFacade().listaFiltrandoReceitaPorTipoCredito(parte.trim(), tiposCredito, sistemaControlador.getExercicioCorrente());
        }
        return null;
    }
