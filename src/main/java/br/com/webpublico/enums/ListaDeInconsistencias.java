 ...
 * At 15:26
 */
public enum ListaDeInconsistencias implements EnumComDescricao {
    ...
    private ListaDeInconsistencias(String descricao, String tipoDeRecusa, String codigo) {
        this.descricao = descricao;
        this.tipoDeRecusa = tipoDeRecusa;
        this.codigo = codigo;
    }

    public static ListaDeInconsistencias getInconcistenciaPorCodigo(String codRetorno) {
        for (ListaDeInconsistencias inconsistencia : ListaDeInconsistencias.values()) {
