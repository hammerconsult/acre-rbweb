 ...
 */
public enum TipoLogradouroEnderecoCorreio {
    A("Área"),
    AC("Acesso"),
    ACA("Acampamento"),
    ACL("Acesso Local"),
    ...
    TipoLogradouroEnderecoCorreio(String descricao) {
    ...
    public static TipoLogradouroEnderecoCorreio buscarTipoLogradouroPelaDescricao(String descricao) {
        if (descricao != null) {
            for (TipoLogradouroEnderecoCorreio tipo : values()) {
                if (StringUtil.removerApenasAcentuacao(tipo.descricao.trim().toLowerCase()).
                    equals(StringUtil.removerApenasAcentuacao(descricao.trim().toLowerCase()))) {
