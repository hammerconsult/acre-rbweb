 ...
 * @author peixe
 */
public class GeraFuncaoFormula implements GeraFuncao,Serializable {
    ...
    public String executarGeracao(String nomeFunction, String corpo, String codigoEventoFP, TipoExecucaoEP tipoExecucaoEP) {
        ...
        if (tipoExecucaoEP.equals(TipoExecucaoEP.RPA)) {
            builder.append("if(mapFormula[").append(codigoEventoFP).append("]){\n");
            builder.append(" return Number(mapFormula[").append(codigoEventoFP).append("]);\n");
            builder.append("}\n");
            builder.append(corpo).append("\n");
        } else {
            builder.append("var _quant = " + NomeObjetosConstantesScriptFP.NOME_OBJETO_JAVA + ".recuperaQuantificacaoLancamentoTipoValor(ep, '").append(codigoEventoFP).append("', " + NomeObjetosConstantesScriptFP.NOME_OBJETO_MES_CALCULO + ", " + NomeObjetosConstantesScriptFP.NOME_OBJETO_ANO_CALCULO + ");\n");
...
//                + "var _quant = " + NomeObjetosConstantesScriptFP.NOME_OBJETO_JAVA + ".recuperaQuantificacaoLancamentoTipoValor(ep, '" + codigoEventoFP + "');\n"
//                + "if ( _quant >= 0 ) {\n"
//                + "return _quant;\n"
//                + "} else {\n"
//                + corpo + "\n"
