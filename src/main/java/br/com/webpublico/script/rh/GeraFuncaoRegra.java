 ...
 * @author peixe
 */
public class GeraFuncaoRegra implements GeraFuncao, Serializable {
    ...
    @Override
    public String executarGeracao(String nomeFunction, String corpo, String codigoEvento, TipoExecucaoEP tipoExecucaoEP) {
