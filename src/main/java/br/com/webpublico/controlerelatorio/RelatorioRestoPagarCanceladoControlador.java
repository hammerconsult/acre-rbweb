...
import br.com.webpublico.entidadesauxiliares.RelatorioRestoPagar;
...
@URLMappings(mappings = {
    @URLMapping(id = "relatorio-resto-pagar-cancelado", pattern = "/relatorio/restos-a-pagar-cancelado/", viewId = "/faces/financeiro/relatorio/relatorio-resto-pagar-cancelado.xhtml"),
})

@ManagedBean
public class RelatorioRestoPagarCanceladoControlador extends RelatorioRestoPagarSuperControlador implements Serializable {

    private TipoExibicao tipoExibicao;

    @URLAction(mappingId = "relatorio-resto-pagar-cancelado", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setApi("contabil/resto-pagar-cancelado/");
    ...
    public String getCaminhoRelatorio() {
        return "/relatorio/restos-a-pagar-cancelado/";
    }
    ...
    public String getNomeArquivo() {
        return "RESTOS-A-PAGAR-CANCELADO-" + getNumeroRelatorio() + "PERIODO" + getDataPorPeriodoParaImprimir();
    }
