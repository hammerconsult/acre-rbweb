...
@URLMappings(mappings = {
    @URLMapping(id = "relatorio-lei4320-anexo2-despesa", pattern = "/relatorio/lei4320/anexo2-despesa/", viewId = "/faces/financeiro/relatorio/relatorioanexo2despesaexecucao.xhtml")
})
@ManagedBean
public class RelatorioAnexo02ExecucaoDespesaControlador extends AbstractRelatorioItemDemonstrativo implements Serializable {

    @URLAction(mappingId = "relatorio-lei4320-anexo2-despesa", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    public void limparCampos() {
        portalTipoAnexo = PortalTipoAnexo.ANEXO2_DESP_LEI_4320;
        super.limparCampos();
    }
    ...
    public String getNumeroRelatorio() {
        return unidadeGestora == null ? "02-DESPESA-CSL" : "02-DESPESA-" + unidadeGestora.getCodigo();
    }

    @Override
    public String getNomeArquivo() {
        return "RelatorioLEI4320Anexo02Despesa";
    }

    @Override
    public String getApi() {
        return "contabil/lei4320-anexo2-despesa/";
    }
