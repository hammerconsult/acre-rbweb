...
@ManagedBean(name = "relatorioAnexo06ExecucaoControlador")
@ViewScoped
@URLMappings(mappings = {
    @URLMapping(id = "relatorio-lei4320-anexo6", pattern = "/relatorio/lei4320/anexo6/", viewId = "/faces/financeiro/relatorio/relatorioanexo6loaexecucao.xhtml"),
})

public class RelatorioAnexo06ExecucaoControlador extends AbstractRelatorioItemDemonstrativo {

    @URLAction(mappingId = "relatorio-lei4320-anexo6", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    public void limparCampos() {
        portalTipoAnexo = PortalTipoAnexo.ANEXO6_LEI_4320;
        super.limparCampos();
    }
    ...
    public String getNumeroRelatorio() {
        return unidadeGestora == null ? "06-CSL" : "06-" + unidadeGestora.getCodigo();
    }

    @Override
    public String getNomeArquivo() {
        return "RelatorioLEI4320Anexo06";
    }

    @Override
    public String getApi() {
        return "contabil/lei4320-anexo6/";
    }
