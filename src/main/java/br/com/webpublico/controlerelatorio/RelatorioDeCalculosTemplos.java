...
@ManagedBean(name = "relatorioDeCalculosTemplos")
@ViewScoped
@URLMappings(mappings = {
    @URLMapping(id = "novoRelatorioDeCalculosTemplos",
        pattern = "/relatorios/iptu-templos-igrejas/",
        viewId = "/faces/tributario/iptu/relatorio/calculostemplos.xhtml"),
})
public class RelatorioDeCalculosTemplos extends AbstractReport implements Serializable {
    ...
    @URLAction(mappingId = "novoRelatorioDeCalculosTemplos", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    public void novo() {
        cadastroInicial = "1";
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setNomeRelatorio("RELATÓRIO-IPTU-TEMPLOS-IGREJA");
            dto.setApi("tributario/iptu-templos-igrejas/");
