 ...
 */
@ManagedBean
public class RelatorioReceitaOrcamentarioControle extends AbstractReport implements Serializable {
    ...
    public List<HierarquiaOrganizacional> completaHierarquiaOrganizacional(String parte) {
        return hierarquiaOrganizacionalFacade.filtrandoHierarquiaHorganizacionalEntidade(parte, sistemaControlador.getExercicioCorrente());
    }
    ...
    public Boolean validaExercicio() {
        if (exercicioSelecionado != null) {
            //System.out.println("exercicio: " + exercicioSelecionado);
            return true;
        } else {
    ...
    public Boolean validaHierarquia() {
        if (hierarquiaOrganizacionalSelecionada != null) {
            //System.out.println("hierarquia OK: " + hierarquiaOrganizacionalSelecionada);
            return true;
        } else {
            ...
            //System.out.println("hierarquia NAO OK: " + hierarquiaOrganizacionalSelecionada);
            return false;
        }
    }
    ...
    public void gerarRelatorioOrcamentario() throws JRException, IOException {
        ...
        if (hierarquiaOrganizacionalSelecionada.getSubordinada() != null) {
            //System.out.println("Unidade Org------- " + hierarquiaOrganizacionalSelecionada.getSubordinada().getEntidade().getId());
            ////System.out.println("Unidade Superior --" + hierarquiaOrganizacionalSelecionada.getSuperior().getId());
            String arquivoJasper = "RelatorioReceitaPorUnidade.jasper";
            ...
            parameters.put("UNIDADE", hierarquiaOrganizacionalSelecionada.getSubordinada().getId());
