...
@URLMappings(mappings = {
    @URLMapping(id = "relatorio-demonstrativo-emenda-anexoII", pattern = "/relatorio-demonstrativo-emenda-anexoII/", viewId = "/faces/financeiro/relatorio/relatorio-demonstrativo-emenda-anexoII.xhtml")
})
@ManagedBean
public class RelatorioDemonstrativoEmendaAnexoIIControlador implements Serializable {
    ...
    @URLAction(mappingId = "relatorio-demonstrativo-emenda-anexoII", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    public void limparCampos() {
        modalidadeEmenda = ModalidadeEmenda.INDIRETA;
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setNomeRelatorio("RELATORIO-DEMONSTRATIVO-EMENDA-ANEXO-II");
