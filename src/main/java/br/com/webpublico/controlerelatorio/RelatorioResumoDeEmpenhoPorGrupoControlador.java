 ...
 * @author boy
 */
@ManagedBean(name = "relatorioResumoDeEmpenhoPorGrupoControlador")
@ViewScoped
@URLMappings(mappings = {
    @URLMapping(id = "gerarRelatorioResumoDeEmpenho", pattern = "/relatorio/resumo-de-empenho/", viewId = "/faces/rh/relatorios/relatorioresumodeempenho.xhtml")
})
public class RelatorioResumoDeEmpenhoPorGrupoControlador extends AbstractReport implements Serializable {
    ...
    public RelatorioResumoDeEmpenhoPorGrupoControlador() {
    }
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setNomeRelatorio("RELATORIO-RESUMO-DE-EMPENHO");
            dto.setApi("rh/resumo-de-empenho/");
