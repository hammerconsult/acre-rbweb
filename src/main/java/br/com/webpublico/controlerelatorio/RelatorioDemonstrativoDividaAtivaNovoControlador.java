...
@ViewScoped
@URLMapping(id = "relatorio-demonstrativo-divida-ativa-2", pattern = "/relatorio/demonstrativo-divida-ativa-2/", viewId = "/faces/financeiro/relatorio/relatoriodemonstrativodividaativa-2.xhtml")
@ManagedBean
public class RelatorioDemonstrativoDividaAtivaNovoControlador extends RelatorioContabilSuperControlador {

    private Conta contaDeDestinacao;
    private Intervalo intervalo;

    public RelatorioDemonstrativoDividaAtivaNovoControlador() {
    }

    @URLAction(mappingId = "relatorio-demonstrativo-divida-ativa-2", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    ...
    private RelatorioDTO montarRelatorioDto() {
        ...
        dto.setApi("contabil/demonstrativo-divida-ativa-2/");
        return dto;
    }
    ...
    public String getNomeRelatorio() {
        return "demonstrativo-divida-ativa-2";
    }
