...
@URLMappings(mappings = {
    @URLMapping(id = "relatorio-resto-pagar-inscricao", pattern = "/relatorio/restos-a-pagar-inscricao-exercicio/", viewId = "/faces/financeiro/relatorio/relatorio-resto-pagar-inscrito-exercicio.xhtml"),
})

@ManagedBean
public class RelatorioRestoPagarInscritoExercicioControlador extends RelatorioRestoPagarSuperControlador implements Serializable {

    @URLAction(mappingId = "relatorio-resto-pagar-inscricao", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setApi("contabil/resto-pagar-inscricao/");
    ...
    public String getCaminhoRelatorio() {
        return "/relatorio/restos-a-pagar-inscricao-exercicio/";
    }
    ...
    private void filtrosParametrosDatas(List<ParametrosRelatorios> parametros) {
        parametros.add(new ParametrosRelatorios(" trunc(afe.dataGeracao)", ":DATAINICIAL", ":DATAFINAL", OperacaoRelatorio.BETWEEN, getDataInicialFormatada(), getDataFinalFormatada(), 2, true));
    ...
    public String getNomeArquivo() {
        return "RESTOS-A-PAGAR-INSCRICAO-EXERCICIO-" + getNumeroRelatorio() + "PERIODO" + getDataPorPeriodoParaImprimir() + "-REFERENCIA" + getDataReferenciaParaImprimir();
    }
}
