...
@ManagedBean(name = "relatorioDeCalculosPublico")
@ViewScoped
@URLMappings(mappings = {
    @URLMapping(id = "novoRelatorioDeCalculosPublico",
        pattern = "/relatorios/iptu-patrimonio-publico/",
        viewId = "/faces/tributario/iptu/relatorio/calculospublico.xhtml"),
})
public class RelatorioDeCalculosPublico extends AbstractReport implements Serializable {
    ...
    @URLAction(mappingId = "novoRelatorioDeCalculosPublico", phaseId = URLAction.PhaseId.RENDER_RESPONSE, onPostback = false)
    public void novo() {
        cadastroInicial = "1";
    ...
    public void gerarRelatorio(String tipoRelatorioExtensao) {
        try {
            ...
            dto.setNomeRelatorio("RELATÓRIO-CÁLCULO-PATRIMÔNIO-PÚBLICO");
            dto.setApi("tributario/iptu-patrimonio-publico/");
