 ...
 */
@Stateless
public class IncidenciaTributariaIRRFFacade extends AbstractFacade<IncidenciaTributariaIRRF> {

    @PersistenceContext(name = "webpublicoPU")
    private EntityManager em;

    public IncidenciaTributariaIRRFFacade() {
    ...
    public boolean hasCodigoCadastrado(IncidenciaTributariaIRRF selecionado) {
        String sql = "select * from IncidenciaTributariaIRRF where codigo = :codigo";
