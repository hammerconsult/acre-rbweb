...
@Stateless
public class GeraValorDividaAlvaraLocalizacao extends ValorDividaFacade {

    public GeraValorDividaAlvaraLocalizacao() {
        super(false);
    }
    ...
    protected void lancaItem(ValorDivida valorDivida) {
        ...
        itemValorDivida.setTributo(configuracaoTributarioFacade.retornaUltimo().getTributoAlvaraLocalizacao());
    ...
    protected void defineVencimentosParcelas(Calculo calculo, OpcaoPagamento op, int i, ParcelaValorDivida parcelaValorDivida, ValorDivida valorDivida, Calendar vencimento, Integer numeroParcelas) {
        parcelaValorDivida.setVencimento(((CalculoAlvaraLocalizacao) calculo).getDataVencimento());
    }
}
